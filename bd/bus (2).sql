...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2025 a las 19:41:27
...
--
-- Estructura de tabla para la tabla `historial_tarjetas`
--
...
CREATE TABLE `historial_tarjetas` (
  ...
  `tipo_movimiento` enum('recarga','gasto') DEFAULT NULL,
  `monto` int(11) DEFAULT NULL,
  `descripcion` varchar(255) DEFAULT NULL,
  `fecha_movimiento` datetime DEFAULT NULL,
  `id_recarga` int(11) DEFAULT NULL,
  `estado_recarga` varchar(50) DEFAULT NULL,
  `fecha_recarga` datetime DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `historial_tarjetas`
--

INSERT INTO `historial_tarjetas` (`id`, `id_tarjeta`, `id_usuario`, `fecha_registro`, `token_tarjeta`, `ultimos_4`, `tipo_tarjeta`, `marca`, `creada_en`, `tipo_movimiento`, `monto`, `descripcion`, `fecha_movimiento`, `id_recarga`, `estado_recarga`, `fecha_recarga`, `id_transaccion`, `token_ws`, `buy_order`, `session_id`, `amount`, `response_code`, `authorization_code`, `payment_type`, `installments`, `transaction_date`, `status`) VALUES
(1, 3, 3, '2025-11-27 15:35:40', 'tok_ccc1a2666de46f28', '6623', 'credito', 'visa', '2025-11-27 15:25:02', NULL, NULL, NULL, NULL, 20, 'pagado', '2025-11-27 15:25:24', 8, '01abd4a5dca8a067404988a2e2a6bf5b0a837ec92d9f679d0cb8148b3084fac5', 'recarga-1764267923', 'usuario-3-1764267923', 12345678, 0, '1213', 'VN', 0, '2025-11-27 18:25:23', 'pagado');
...
CREATE TABLE `movimientos` (
  ...
  `tipo` enum('recarga','gasto') NOT NULL,
...
INSERT INTO `movimientos` (`id_movimiento`, `id_usuario`, `tipo`, `monto`, `descripcion`, `fecha`) VALUES
(4, 3, 'recarga', 12345678, 'Recarga desde Webpay', '2025-11-27 18:26:07');
...
(21, 3, 4, 20000, 'pendiente', '2025-11-27 15:39:36');
...
(4, 3, 'tok_6b26e847931035f1', '6623', 'credito', 'visa', '2025-11-27 15:36:48');
...
--
-- Indices de la tabla `historial_tarjetas`
--
ALTER TABLE `historial_tarjetas`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `historial_tarjetas`
--
ALTER TABLE `historial_tarjetas`
...
--
ALTER TABLE `recargas`
  MODIFY `id_recarga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
